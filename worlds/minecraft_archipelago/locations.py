...
location_table: Dict[str, LocationData] = {
    ...
    # ── Lootable Checks ───────────────────────────────────────────────────────
    # All 41 possible checks are defined here.
    # Only the first N are included in any given game, controlled by the
    # lootable_checks YAML option (default 20).
    # IDs start at 42500

    "Lootable Check 1":  LocationData(42500, "Overworld"),
    "Lootable Check 2":  LocationData(42501, "Overworld"),
    "Lootable Check 3":  LocationData(42502, "Overworld"),
    "Lootable Check 4":  LocationData(42503, "Overworld"),
    "Lootable Check 5":  LocationData(42504, "Overworld"),
    "Lootable Check 6":  LocationData(42505, "Overworld"),
    "Lootable Check 7":  LocationData(42506, "Overworld"),
    "Lootable Check 8":  LocationData(42507, "Overworld"),
    "Lootable Check 9":  LocationData(42508, "Overworld"),
    "Lootable Check 10": LocationData(42509, "Overworld"),
    "Lootable Check 11": LocationData(42510, "Overworld"),
    "Lootable Check 12": LocationData(42511, "Overworld"),
    "Lootable Check 13": LocationData(42512, "Overworld"),
    "Lootable Check 14": LocationData(42513, "Overworld"),
    "Lootable Check 15": LocationData(42514, "Overworld"),
    "Lootable Check 16": LocationData(42515, "Overworld"),
    "Lootable Check 17": LocationData(42516, "Overworld"),
    "Lootable Check 18": LocationData(42517, "Overworld"),
    "Lootable Check 19": LocationData(42518, "Overworld"),
    "Lootable Check 20": LocationData(42519, "Overworld"),
    "Lootable Check 21": LocationData(42520, "Overworld"),
    "Lootable Check 22": LocationData(42521, "Overworld"),
    "Lootable Check 23": LocationData(42522, "Overworld"),
    "Lootable Check 24": LocationData(42523, "Overworld"),
    "Lootable Check 25": LocationData(42524, "Overworld"),
    "Lootable Check 26": LocationData(42525, "Overworld"),
    "Lootable Check 27": LocationData(42526, "Overworld"),
    "Lootable Check 28": LocationData(42527, "Overworld"),
    "Lootable Check 29": LocationData(42528, "Overworld"),
    "Lootable Check 30": LocationData(42529, "Overworld"),
    "Lootable Check 31": LocationData(42530, "Overworld"),
    "Lootable Check 32": LocationData(42531, "Overworld"),
    "Lootable Check 33": LocationData(42532, "Overworld"),
    "Lootable Check 34": LocationData(42533, "Overworld"),
    "Lootable Check 35": LocationData(42534, "Overworld"),
    "Lootable Check 36": LocationData(42535, "Overworld"),
    "Lootable Check 37": LocationData(42536, "Overworld"),
    "Lootable Check 38": LocationData(42537, "Overworld"),
    "Lootable Check 39": LocationData(42538, "Overworld"),
    "Lootable Check 40": LocationData(42539, "Overworld"),
    "Lootable Check 41": LocationData(42540, "Overworld"),
    "Lootable Check 42": LocationData(42541, "Overworld"),
}